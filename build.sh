...
then
	...
	g++ tests/TestMain.o tests/TestLegalPiecesMoves.cpp tests/TestLib.cpp tests/TestBoard.cpp Src/CharHelper.cpp Src/math.cpp Src/board.cpp Src/analyzer.cpp Src/stringHelper.cpp Src/chessLib.cpp -o tests/test 
	./tests/test
...
then
	printf "Starting unit testing (Debug mode)\n"
        #don't recompile the catch library every unit testing
        #ref :https://github.com/catchorg/Catch2/blob/devel/docs/slow-compiles.md
        g++ -g tests/TestMain.o tests/TestLegalPiecesMoves.cpp tests/TestLib.cpp tests/TestBoard.cpp Src/CharHelper.cpp Src/math.cpp Src/board.cpp Src/analyzer.cpp Src/stringHelper.cpp Src/chessLib.cpp -o tests/test 
        gdb tests/test
